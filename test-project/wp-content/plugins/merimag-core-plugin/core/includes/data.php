 ...
 */
function merimag_get_image_size( $size = 'medium' ) {
  switch ($size) {
      case 'small':
          return array(200, 150, 'bfi_thumb' => true);
          break;
      case 'medium':
          return array(400, 300, 'bfi_thumb' => true);
          break;
      case 'big':
          return array(800, 600, 'bfi_thumb' => true);
          break;
      case 'large':
          return array(1200, 800, 'bfi_thumb' => true);
          break;
      case 'full':
          return array(1920, 1080, 'bfi_thumb' => true);
          break;
      default:
          return array(400, 300, 'bfi_thumb' => true);
          break;
...
function merimag_get_google_fonts( $items = false ) {
    $saved_data = get_transient( 'merimag_google_fonts_list' );
    ...
    if (
        ...
        if (
            ...
            set_transient( 'merimag_google_fonts_list',
                array(
                    'last_update' => time(),
                    'fonts'       => $body
                ) );
    ...
    $fonts_array = json_decode(  $saved_data['fonts'], true );
