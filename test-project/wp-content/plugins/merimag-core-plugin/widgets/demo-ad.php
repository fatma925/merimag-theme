...
class Merimag_Demo_Ad extends WP_Widget {
    ...
    function __construct() {
        ...
        $widget_ops = array( 'description' => __( 'Demo ad', 'merimag' ) );
        parent::__construct( false, __( 'Demo Ad', 'merimag' ), $widget_ops );
        
        //Create our options by using merimag option types
        $this->options = merimag_get_demo_ad_options();
        $this->prefix = 'merimag_demo_ad';
    }
    ...
    function widget( $argss, $instance ) {
        ...
        $atts['size'] = isset( $instance['size'] ) ? $instance['size'] : false;
        $this->view( $atts );
    ...
    function view( $atts ) {
        ...
        merimag_get_shortcode_html('demo-ad', $atts );
    }
...
add_action( 'widgets_init', function() { return register_widget("Merimag_Demo_Ad"); } );