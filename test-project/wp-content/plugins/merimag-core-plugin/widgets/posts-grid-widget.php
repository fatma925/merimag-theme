...
class Merimag_Posts_Grid_Widget extends WP_Widget {
    ...
    function __construct() {
        ...
        $widget_ops = array( 'description' => __( 'Display posts with multiple columns', 'merimag' ) );
        parent::__construct( false, __( 'Posts Grid Widget', 'merimag' ), $widget_ops );
        
        //Create our options by using merimag option types
        $this->options = merimag_get_posts_grid_options_for_widget();
        $this->prefix = 'merimag_posts_grid_widget';
    }
...
add_action( 'widgets_init', function() { return register_widget("Merimag_Posts_Grid_Widget"); } );