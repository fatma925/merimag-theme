...
class Merimag_Simple_Posts_Widget extends WP_Widget {
    ...
    function __construct() {
        ...
        $widget_ops = array( 'description' => __( 'Display posts with filters', 'merimag' ) );
        parent::__construct( false, __( 'Simple Posts Widget', 'merimag' ), $widget_ops );
        
        //Create our options by using merimag option types
        $this->options = merimag_get_simple_posts_options_for_widget();
        $this->prefix = 'merimag_simple_posts_widget';
    }
...
add_action( 'widgets_init', function() { return register_widget("Merimag_Simple_Posts_Widget"); } );