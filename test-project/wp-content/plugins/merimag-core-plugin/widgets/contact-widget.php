...
class Merimag_Contact_Widget extends WP_Widget {
    ...
    function __construct() {
        ...
        $widget_ops = array( 'description' => __( 'Beautiful contact widget with social icons', 'merimag' ) );
        parent::__construct( false, __( 'Contact Widget', 'merimag' ), $widget_ops );
        
        //Create our options by using merimag option types
        $this->options = merimag_get_contact_infos_options_for_widget();
        $this->prefix = 'merimag_contact_widget';
    }
...
add_action( 'widgets_init', function() { return register_widget("Merimag_Contact_Widget"); } );