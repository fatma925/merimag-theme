...
class Merimag_About_Widget extends WP_Widget {
    ...
    function __construct() {
        ...
        $widget_ops = array( 'description' => __( 'Beautiful about widget with social icons', 'merimag' ) );
        parent::__construct( false, __( 'About Widget', 'merimag' ), $widget_ops );
        
        //Create our options by using merimag option types
        $this->options = merimag_get_general_about_options_for_widget();
        $this->prefix = 'merimag_about_widget';
    }
    ...
    function view( $atts ) {
        ...
        merimag_get_shortcode_html('about', $atts );
    }
...
add_action( 'widgets_init', function() { return register_widget("Merimag_About_Widget"); } );