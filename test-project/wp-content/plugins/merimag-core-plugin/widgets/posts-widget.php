...
class Merimag_Posts_Widget extends WP_Widget {
    ...
    function __construct() {
        ...
        parent::__construct( false, __( 'Posts Widget', 'merimag' ), $widget_ops );
        
        //Create our options by using merimag option types
        $this->options = merimag_get_posts_list_options_for_widget();
...
add_action( 'widgets_init', function() { return register_widget("Merimag_Posts_Widget"); } );