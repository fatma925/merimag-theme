...
add_action( 'elementor/widgets/register', 'merimag_elementor_register_wigdets' );

add_action(	'elementor/widget/before_render_content', function( $widget ) {
	$post_id = get_the_ID();
	
 	$shortcode = str_replace('merimag-', '', $widget->get_name());
	$shortcode = str_replace('_', '-', $shortcode);
	$atts 	   = $widget->get_settings();
	...
	merimag_render_css($block_css, $element_id );
...
add_filter('option_elementor_optimized_dom_output', function() {
...
add_action('init', function() {
  ...
  $optimized_output = get_option('elementor_experiment-e_dom_optimization');
  if( $optimized_output == 'default' ||  $optimized_output = 'inactive') {
