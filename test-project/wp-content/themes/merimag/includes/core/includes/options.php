...
function merimag_get_accordion_options() {
  $options = array(
    ...
    'color' => array(
      ...
      'selectors' => array('{{WRAPPER}} .merimag-accordion-shortcode-title, {{WRAPPER}} .merimag-accordion-shortcode-content' => 'color: {{VALUE}}; border-color: {{VALUE}}'),

    ),
    'title_color' => array(
      'type' => 'color-picker-v2',
      'label' => __('Title color', 'merimag-backend'),
      'selectors' => array('{{WRAPPER}} .merimag-accordion-shortcode-title' => 'color: {{VALUE}};  border-color: {{VALUE}}'),
    ),
    'tabs' => array(
      'type' => 'addable-popup',
...
function merimag_get_ticker_options( $slug = '') {
  $query_options   = merimag_get_query_options( 'post', '', false );
  $general_options = array(
    'ticker_title' => array(
...
function merimag_get_video_playlist_options() {
  $options = array(
    ...
    'principal_color' => array(
      ...
      'selectors' => array( '{{WRAPPER}} .merimag-video-playlist' => '--principal-color: {{VALUE}}'),
    ),
    ...
    if( isset( $choices ) && is_array( $choices ) ) {
      $options = array(
        ...
        'color' => array(
          'type' => 'color-picker-v2',
          'label' => __('Color', 'merimag-backend'),
          'selector' => '.merimag-mailchimp-shortcode',
        ),
        'icon_color' => array(
          'type' => 'color-picker-v2',
          'label' => __('Icon color', 'merimag-backend'),
          'condition' => array('show_newsletter_icon' => 'yes'),
          'selector' => '.merimag-mailchimp-icon',
        ),
        'title_color' => array(
          'type' => 'color-picker-v2',
          'label' => __('Title color', 'merimag-backend'),
          'selector' => '.merimag-mailchimp-title',
        ),
      );
      if( $widget === false ) {
...
function merimag_get_special_heading_options() {
  $options = array(
      ...
      'principal_color' => array(
        ...
        'selectors' => array( '{{WRAPPER}} .merimag-special-heading-shortcode' => '--principal-color: {{VALUE}}'),
      ),
      'title_typography' => array(
        'elementor_type' => 'typography-v3',
        'type' => 'select',
        ...
        $general_title_box_options = array(
          ...
          'image_ratio' => array(
            ...
            'choices' => array(
              ...
              '1-1' => '1:1',
              '2-1' => '2:1',
              'original_ratio' => __('Original ratio', 'merimag-backend')
            ),
          ),
          'grid_style' => array(
              'type'  => 'image-picker',
	...
	$options = array(
      esc_attr( $slug ) . 'ignore_general_style' => array(
        ...
        esc_attr( $slug ) . 'principal_color' => array(
          ...
          'selectors' => array( '{{WRAPPER}} .merimag-block-data-container ' => '--principal-color: {{VALUE}}'),
      ...
      esc_attr( $slug ) . 'text_color' => array(
          ...
          'selectors' => array( '{{WRAPPER}} .merimag-block-data-container ' => '--text-color: {{VALUE}}'),
          'wp-customizer-setting-args' => array(
                  'transport' => 'postMessage'
                ),
      ),
      esc_attr( $slug ) . 'links_color' => array(
          ...
          'selectors' => array( '{{WRAPPER}} .merimag-block-data-container ' => '--links-color: {{VALUE}}'),
          'wp-customizer-setting-args' => array(
                  'transport' => 'postMessage'
                ),
      ),
      esc_attr( $slug ) . 'links_hover_color' => array(
          ...
          'selectors' => array( '{{WRAPPER}} .merimag-block-data-container ' => '--links-hover-color: {{VALUE}}'),
          'wp-customizer-setting-args' => array(
                  'transport' => 'postMessage'
                ),
      ),
      esc_attr( $slug ) . 'borders_color' => array(
          ...
          'selectors' => array( '{{WRAPPER}} .merimag-block-data-container ' => '--borders-color: {{VALUE}}'),
      ...
      esc_attr( $slug ) . 'buttons_color' => array(
          ...
          'selectors' => array( '{{WRAPPER}} .merimag-block-data-container ' => '--buttons-color: {{VALUE}}'),
